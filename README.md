...
-   This will open a new window to search the OPChallenge project
-   Once you select the OPChallenge folder Android Studio will download all the dependencies, so you need to wait a little
